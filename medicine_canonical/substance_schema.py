...
CREATE TABLE substance_match_candidates (
    ...
    match_method TEXT NOT NULL CHECK(match_method IN ('normalized_name_exact','approved_typo_alias','approved_nomenclature_alias','source_wrapper_exact','source_declared_alias','typography_greek','typography_apostrophe','typography_isotope')),
