...
class ManifestContractTest {
    ...
    fun androidShellUsesLocalAssetsAndRustApiBridge() {
        ...
        assertTrue(activity.contains("OcrIntegration"))
        ...
        assertTrue(manifest.contains("ocrFileProviderEnabled"))
    ...
    fun productShellCompilesOcrOnlyWhenRuntimeAssetsAreExplicitlyProvided() {
        val build = java.io.File("build.gradle.kts").readText()
        val activity = java.io.File("src/main/java/com/medicine/android/MainActivity.kt").readText()
        val ocrIntegration = java.io.File("src/ocr/java/com/medicine/android/OcrIntegration.java").readText()
        val noOcrIntegration = java.io.File("src/noOcr/java/com/medicine/android/OcrIntegration.java").readText()
        ...
        assertFalse(noOcrIntegration.contains("/ocr-assets/"))
        assertFalse(noOcrIntegration.contains("MediaStore.ACTION_IMAGE_CAPTURE"))
