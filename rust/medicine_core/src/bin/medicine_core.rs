use medicine_core::{
    inspect_product, inspect_safety_basis, normalize_prescription_draft, MedicineEngine,
};
use serde_json::json;
use std::path::Path;
