...
fn rust_codec_reads_existing_android_data_output_stream_v3_state() {
    // Generated by the pre-consolidation Kotlin ReferenceStateCodec through
    // java.io.DataOutputStream. Keeping this fixture here protects upgrades
    // from existing Android installs when Rust owns state persistence.
