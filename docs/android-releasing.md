...
Local Android development and verification still use Docker/Compose. CI provisions its Android toolchain on GitHub-hosted runners, so the local host does not need a Gradle or Android SDK installation for routine development.
