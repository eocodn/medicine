...
class WebApiTest(unittest.TestCase):
    ...
    def test_mobile_shell_is_served(self) -> None:
        ...
        self.assertIn('href="/static/styles.css?v=20260811e"', response.text)
        self.assertIn('src="/static/app.js?v=20260811d"', response.text)
        ...
        self.assertIn("--bottom-nav-clearance", styles.text)
        self.assertIn(".people-screen", styles.text)
        self.assertIn("#people-list", styles.text)
        self.assertIn("overflow-y: auto", styles.text)
        self.assertIn("#drug-results", styles.text)
        self.assertIn("padding-bottom: var(--bottom-nav-clearance)", styles.text)
