...
class WebApiTest(unittest.TestCase):
    ...
    def test_mobile_shell_is_served(self) -> None:
        ...
        self.assertIn('href="/static/styles.css?v=20260811r"', response.text)
        self.assertIn('src="/static/timeline.js?v=20260811b"', response.text)
        self.assertIn('src="/static/prescription.js?v=20260811c"', response.text)
        self.assertIn('src="/static/app.js?v=20260811t"', response.text)
        ...
        self.assertIn("제품 단위 DUR 매핑 실패", prescription_script.text)
        self.assertIn("성분 단위 DUR 매핑 실패", prescription_script.text)
