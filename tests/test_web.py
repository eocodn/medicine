...
class WebApiTest(unittest.TestCase):
    ...
    def test_mobile_shell_is_served(self) -> None:
        ...
        self.assertIn('href="/static/styles.css?v=20260811s"', response.text)
        self.assertIn('src="/static/timeline.js?v=20260811b"', response.text)
        self.assertIn('src="/static/prescription.js?v=20260811d"', response.text)
        self.assertIn('src="/static/app.js?v=20260811u"', response.text)
