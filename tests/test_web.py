...
class WebApiTest(unittest.TestCase):
    ...
    def test_mobile_shell_is_served(self) -> None:
        ...
        self.assertIn('return `<section class="dur-check conditional">${detailHtml}</section>`;', prescription_script.text)
        self.assertNotIn('<span>${summary}</span></div>${detailHtml}', prescription_script.text)
        self.assertNotIn('conditional-status-badge', prescription_script.text)
