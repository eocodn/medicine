...
test("changed shared assets use fresh cache keys", () => {
  ...
  assert.match(index, /styles\.css\?v=20260903reminders1/);
  assert.match(index, /prescription\.js\?v=20260903state1/);
  assert.match(index, /people\.js\?v=20260903state1/);
  assert.match(index, /app-state\.js\?v=20260903state1/);
  assert.match(index, /app\.js\?v=20260903state1/);
  assert.match(index, /dashboard-runtime\.js\?v=20260903state1/);
  assert.match(index, /product-search\.js\?v=20260823search1/);
  assert.match(index, /dose-actions\.js\?v=20260903state1/);
