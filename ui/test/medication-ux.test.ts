...
test("top bar exposes the active person's name instead of only an initial", () => {
  ...
  assert.match(index, /\/static\/people\.js\?v=20260903state1/);
...
test("medication cards separate DUR review, editing, and regimen completion semantics", () => {
  ...
  assert.ok(splitBadgeIndex < durBadgeIndex);
...
test("home dose actions prioritize normal completion and compact completed states", () => {
  ...
  assert.match(index, /\/static\/styles\.css\?v=20260903reminders1/);
  assert.match(index, /\/static\/prescription-dur\.js\?v=20260818dur1/);
  assert.match(index, /\/static\/prescription\.js\?v=20260903state1/);
  assert.match(index, /\/static\/app-state\.js\?v=20260903state1/);
  assert.match(index, /\/static\/app\.js\?v=20260903state1/);
  assert.match(index, /\/static\/dashboard-runtime\.js\?v=20260903state1/);
  assert.match(index, /\/static\/dose-actions\.js\?v=20260903state1/);
