...
test("home dose actions prioritize normal completion and compact completed states", () => {
  ...
  assert.match(index, /\/static\/styles\.css\?v=20260902product2/);
  assert.match(index, /\/static\/prescription-dur\.js\?v=20260818dur1/);
  assert.match(index, /\/static\/prescription\.js\?v=20260902product2/);
  assert.match(index, /\/static\/app-state\.js\?v=20260902product2/);
  assert.match(index, /\/static\/app\.js\?v=20260902product2/);
