...
class DetectorTrainingTest(unittest.TestCase):
    ...
    def test_agent_control_cli_reports_preflight_as_json(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as raw:
            ...
            self.assertEqual(payload["profile"]["corpus"]["polygon_kind"], "interpolated_text_core_polygon")
            self.assertEqual(payload["profile"]["corpus"]["region_padding_fraction"], 0.5)
