...
def _load_inputs(
    *,
    ...
    if (
        export.get("polygon_kind") != "interpolated_text_core_polygon"
        or export.get("region_padding_fraction") != 0.5
        or export.get("transcription_policy") != "ground_truth_text"
    ):
    ...
    *,
    ...
    return {
        ...
        "corpus": {
            ...
            "region_padding_fraction": inputs["export"]["region_padding_fraction"],
