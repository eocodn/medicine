...
## Deployment boundary
- The standalone HTTP web service (`medicine_app.web`, the Compose `web` service, and browser-served development deployment) is for development and testing only. Do not treat it as a production deployment target unless the user explicitly changes this policy.
